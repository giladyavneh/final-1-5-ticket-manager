...
function App() {
  ...
  const renderTickets=()=>tickets.map(ticket=><Ticket key={ticket.id} restore={restore} title={ticket.title}
    content={ticket.content} email={ticket.userEmail} increaseCounter={()=>setCounter(counter=>counter+1)}
